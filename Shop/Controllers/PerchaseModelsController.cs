...
namespace Shop.Controllers
{
    public class PerchaseModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Brend,Price,Discount,Image,Colour,Size,Page")] PerchaseModel perchaseModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Brend,Price,Discount,Image,Colour,Size,Page")] PerchaseModel perchaseModel)
        {
